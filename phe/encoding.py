...
class EncodedNumber(object):
    ...
    def increase_exponent_to(self, new_exponent):
        """return EncodedNumber: new encoding with same value but having great exponent.
        """
        ...
        return EncodedNumber(new_encoding, new_exponent, self.n, self.max_int)
    ...
    def __truncate(self, a):
        scalar = a.decode()
        return EncodedNumber.encode(scalar)
    ...
    def __rtruediv__(self, other):
        ...
        return EncodedNumber.encode(res)
    ...
    def __add_fixpointnumber(self, other):
        ...
        return EncodedNumber(encoding, x.exponent)
    ...
    def __mul_fixpointnumber(self, other):
        ...
        mul_fixedpoint = EncodedNumber(encoding, exponet)
